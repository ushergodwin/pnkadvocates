...
class DbModel
{
     ...
     *
     * @return DbModel Returns the current instance.
     */
    ...
    /**
     * @param string $query A string containing a custom prepared query statement to execute. Must be a select Query
     ...
     */
    public function customQuery(string $query, array $data = []){
     ...
     */
    public function customUpdate(string $query, array $data){
